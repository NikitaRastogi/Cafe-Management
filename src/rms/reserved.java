...
public void table()
        ...
        public void tabledata() throws ParseException
        {
           ...
           // Time time = (Time) jTable1.getValueAt(r,4);  //??
           String table = jTable1.getValueAt(r,5).toString(); //??
            String avala = jTable1.getValueAt(r,6).toString(); //??
            String iddtt = jTable1.getValueAt(r,7).toString();
           String date1 = jTable1.getValueAt(r,3).toString();
          ...
          datebox.setDate(date2); //??
            timebox.setSelectedItem(jTable1.getValueAt(r,4)); //??
            tablebox.setSelectedItem(table); //??
            availabox.setSelectedItem(avala); //??
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String iddtt = iddttbox.getText().toString(); //??
        ...
        public void clear()
    {
     ...
     timebox.setSelectedItem(null); //??
     availabox.setSelectedItem(null); //??
     iddttbox.setText(""); //??
